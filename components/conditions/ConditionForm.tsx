...
interface ConditionFormProps {
  initialData?: ConditionType | null; //Must have "?" to Condition it optional
}

const ConditionForm: React.FC<ConditionFormProps> = ({ initialData }) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const url = initialData
        ? `/api/conditions/${initialData._id}`
        : "/api/conditions";
